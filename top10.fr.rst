...
- `Conan the Barbarian (1982) <https://fr.wikipedia.org/wiki/Conan_le_Barbare_%28film%29>`_,
...
- `Retour vers le Futur (I) <https://fr.wikipedia.org/wiki/Retour_vers_le_futur>`_,
...
- `Ellen Page <https://fr.wikipedia.org/wiki/Ellen_Page>`_, principalement dans `Juno`_, `Hard Candy <https://fr.wikipedia.org/wiki/Hard_Candy_%28film%29>`_, `Bliss <https://fr.wikipedia.org/wiki/Bliss_%28film%29>`_ and `To Rome with love <https://fr.wikipedia.org/wiki/To_Rome_with_Love_%28film%29>`_.
...
- `Jim Carrey <https://fr.wikipedia.org/wiki/Jim_Carrey>`_, principalement dans `The Truman Show`_, `The Mask <https://fr.wikipedia.org/wiki/The_Mask_%28film%29>`_, `Bruce Tout Puissant <https://fr.wikipedia.org/wiki/Bruce_tout_puissant>`_ and `I Love you Philip Morris <https://fr.wikipedia.org/wiki/I_Love_You_Phillip_Morris>`_.
- `Louis de Funès <https://fr.wikipedia.org/wiki/Louis_de_Funès>`_, principalement dans les films *Les Gendarmes* and la série des *Fantomas*.
- `Natalie Portman <https://fr.wikipedia.org/wiki/Natalie_Portman>`_, principalement dans Leon, les films `Star Wars`_ et `Garden State`_.
...
- `Uma Thurman <https://fr.wikipedia.org/wiki/Uma_Thurman>`_, principalement dans `Pulp Fiction`_, `Gattaca <https://fr.wikipedia.org/wiki/Gattaca>`_ and `Kill Bill <https://fr.wikipedia.org/wiki/Kill_Bill>`_.
...
- `Scrubs <https://fr.wikipedia.org/wiki/Scrubs_(TV_Series)>`_ (série humoristique américaine)
- `Tari Tari <https://fr.wikipedia.org/wiki/Tari_Tari>`_ (animé japonais)
- `Friends <https://fr.wikipedia.org/wiki/Friends>`_ (série humoristique américaine)
- `Bref <https://fr.wikipedia.org/wiki/Bref>`_ (série humoristique française)
- `Star Wars: the Clone Wars <https://fr.wikipedia.org/wiki/Star_Wars:_the_Clone_Wars_(2008_TV_Series)>`_ (animé américaine)
- `The Big Bang Theory <https://fr.wikipedia.org/wiki/The_Big_Bang_Theory>`_ (série humoristique américaine)
- `Avatar, the Last Airbender <https://fr.wikipedia.org/wiki/Avatar,_The_Last_Airbender>`_ (animé américaine)
...
- `Time in a Bottle <https://www.youtube.com/results?search_query=jim+croce+time+in+a+bottle>`_, `Jim Croce <https://fr.wikipedia.org/wiki/Jim_Croce>`_ (`connue pour avoir été utilisée dans cette scène mythique <https://www.youtube.com/watch?v=1NnyVc8r2SM>`_)
...
.. sidebar:: Game Boy ? *Vraiment ?*

   Les jeux Game Boy et GB Advance sont les meilleurs, *et voilà*.
...
- `Age of Mythology <https://fr.wikipedia.org/wiki/Age_of_Mythology>`_ (Real-Time Tactical game)
- `Bastion I <https://fr.wikipedia.org/wiki/Bastion_%28jeu_vid%C3%A9o%29>`_ (poetic RPG)
- `Evoland I <https://fr.wikipedia.org/wiki/Evoland>`_ (unique game)
- `Rift <https://fr.wikipedia.org/wiki/Rift:_Planes_of_Telara>`_ (MMORPG)
- `Grim Dawn <https://fr.wikipedia.org/wiki/Grim_Dawn>`_ (recent ARPG)
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
- Avignon (la ville et ses théatres !)
- Paris (surtout le 5ème arrondissement, le *"Quartier Latin"*)
- La Ciotat (le village et sa plage)
- Briançon (les montagnes)
- Corte (en Corse)
- Grenoble (la ville et son fort (la Bastille))
- Nyons (le village et sa rivière)
- La Rochelle (la port, surtout)
- Luminy (à Marseille, le meilleur campus universitaire que je connaisses !)
- Pau (son château, surtout)
...
- London (Royaume-Uni)
- Berlin (Allemagne)
- Et le dernier mais non des moindres : Cachan (France) -- oui ben j'y habite donc autant apprécier...
...
- Gaston Lagaffe (14 tomes originaux, par Franquin)
- Black Sad (4 tomes, par J. Guarnido & J. D. Canales)
- Les Arcanes du Midi-Minuit (par J.-C. Gaudin & C. Trichet)
- Le Donjon de Naheulbeuk (par J. Lang & M. Poinsot)
...
- `Howard Philip Lovecraft <https://fr.wikipedia.org/wiki/H._P._Lovecraft>`_ (Américain, early 20ème, maître des nouvelles d'horreur)
- `Bernard-Marie Koltès <https://fr.wikipedia.org/wiki/Bernard-Marie_Koltès>`_ (théatre, 20ème, surtout pour "Retour au désert", "La Nuit juste avant les forêts", "Combat de nègre et de chiens", et "Quai Ouest")
...
- `Timothy Zahn <https://fr.wikipedia.org/wiki/Timothy_Zahn>`_ (Sci-Fi, 20ème, surtout connu pour sa `trilogie Star Wars <https://en.wikipedia.org/wiki/Thrawn_trilogy>`_)
- `Noëlle Renaude <https://fr.wikipedia.org/wiki/Noëlle_Renaude>`_ (théatre, 20ème, surtput pour "Les Cendres et les lampions" et "À tous ceux qui")
