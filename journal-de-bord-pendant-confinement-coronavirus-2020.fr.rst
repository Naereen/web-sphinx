...
- Lundi 27 avril : ajouts d'articles sur mes blogues `de cuisine <cuisine/>`_ et `de zéro déchet <zero-dechet/>`_, après de longs mois sans y avoir touché ! Et ces nouvelles pages ici : `<jitsi.fr.html>`_, `<twitch.fr.html>`_, `<pokemon.fr.html>`_, `<carte-confinement.fr.bhtml>`_ (à faire).
