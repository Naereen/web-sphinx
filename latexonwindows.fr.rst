...
(Lien direct : http://www.xm1math.net/texmaker/texmakerwin32_install.exe (55 Mo).)
...
.. note:: Sur Linux ?
   ...
   Pour un éditeur spécifique à $\\LaTeX{}$, TeXMaker est disponible, mais il y a aussi `Kile <http://kile.sourceforge.net/>`_ par exemple.


`Cette liste <https://en.wikipedia.org/wiki/Comparison_of_TeX_editors>`_ peut aider à choisir son éditeur pour $\\LaTeX{}$.


Distribution
^^^^^^^^^^^^
Et MikTeX pour la distribution $\\LaTeX{}$ : `MikTex.org/2.9/setup <http://www.miktex.org/2.9/setup>`_.
...
Soucis ?
^^^^^^^^
Si un problème surviens en suivant les explications françaises, vous pouvez consulter : `cette page (en anglais) <http://www.miktex.org/howto/install-miktex>`_.`
...
.. note:: Exemple de maths écrites avec LaTeX ?
   ...
   - `math <math.html>`_, montre des exemples simples intégrées à mes pages web, écrites en `rST <demo.html>`_.
   - `cet exemple de StrapDown.js <http://lbesson.bitbucket.org/md/example5.html>`_.
