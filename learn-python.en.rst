...
#. And if you want some examples of what Python can be used for, I wrote about 35 examples here `Bitbucket.org/lbesson/python-demos <https://bitbucket.org/lbesson/python-demos/src/master/>`_, which cover now various domains, from image analysis, statistical machine learning, numerical computations (`like solving a non-linear PDE <https://bitbucket.org/lbesson/python-demos/src/master/PDE_02_2015/>`_), plotting, linear algebra, symbolic computation (with `SymPy <https://www.sympy.org/>`_), bits of simple algorithms and more!
