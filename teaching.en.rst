...
^^^^^^^^^^^^^^^^^^^^^^
- `CS101 @ MEC <http://www.mahindraecolecentrale.edu.in/portal/course/info.php?id=27>`_: in charge of the course.
...
^^^^^^^^^^^^^^^^^^^^^^^
- `MA101 @ MEC <http://www.mahindraecolecentrale.edu.in/portal/course/info.php?id=12>`_ (July - December 2014). In charge of 3 groups (out of 8) for Maths tutorials (introduction to calculus and logical thinking).

.. todo:: More details, and external/internal links (Moodle, slides, etc).

First semester of 2014
^^^^^^^^^^^^^^^^^^^^^^
- Regularly grading exam answer scripts @ corrections-rue-ulm !
- Occasionally helping high-school students and in charge of oral exams.
