...
1. désactiver les publicités, avec `uBlock Origin <https://addons.mozilla.org/fr/firefox/addon/ublock-origin>`_ ; C'est mal de faire ça ? Je ne trouve pas, de toutes façons je ne cliquerai *jamais* sur une pub ! Lisez `ce petit article en mode poème <https://coryd.dev/posts/2023/i-block-ads/>`_.
