...
# documentation.
# FIXME: les valeurs ici n'ont plus d'importances, il faut modifier directement le CSS
OLD_html_theme_options = {
...
%
% (c) 2011-2014 Lilian BESSON, http://perso.crans.org/besson/
%
%
\usepackage{lmodern}
...
epub_copyright = u'2011-2014, Lilian Besson'
