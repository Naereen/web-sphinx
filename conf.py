...
# Un ajout : (ref https://perso.crans.org/besson/runblock.html#des-ajouts)
...
html_sidebars = {
    ...
    '*.fr':         [
        'mainpage.html',
        'social_icons.fr.html',
        # 'corner-ribbon.fr.html',
        'externallinks.fr.html',
        'language-selector.html',
        'searchbox.fr.html',
        'relations.fr.html'
    ],
    '*.en':         [
        'mainpage.html',
        'social_icons.en.html',
        # 'corner-ribbon.en.html',
        'externallinks.en.html',
        'language-selector.html',
        'searchbox.en.html',
        'relations.en.html'
    ],
...
html_use_opensearch = 'https://perso.crans.org/besson/'
...
%
% (c) 2011-2021 Lilian BESSON, https://perso.crans.org/besson/
%
%
\usepackage{lmodern}
...
epub_copyright = u'2011-2021, Lilian Besson'
