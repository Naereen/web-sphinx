...
--------
 ...
 Si ce n'est pour avoir une seule page présentant plein de liens vers 
 des services utiles (et variés).
...
* `Exiv 2 <http://www.exiv2.org/>`_, un outil pour effacer les données EXIF
  des images.
