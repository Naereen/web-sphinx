...
------------------------------------
 * :Date de Naissance: 12 Janvier 1993. Âge : 21 ans.
 ...
 * **ANSI Colors** : un script et un module pour ``Python 2`` pour utiliser les couleurs en mode textuel dans un terminal.
   Disponible en téléchargement sur `PyPi <https://pypi.python.org/pypi/ANSIColors-balises>`_ (près de 2500 téléchargements pour l'instant).
